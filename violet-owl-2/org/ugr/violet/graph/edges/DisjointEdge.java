 ...
 *
 */
public class DisjointEdge extends OntologyEdge {
	...
	private OWLEntity e1 = null;
	private OWLEntity e2 = null;
	
	public DisjointEdge(OWLEntity ent1, OWLEntity ent2){
		super();
		e1 = ent1;
		e2 = ent2;
	}
	...
	public boolean checkLink(OWLEntity ent){
		if (ent.toString().equals(e1.toString()) )
			return true;
		else if (ent.toString().endsWith(e2.toString()))
			return true;
		else return false;
	}
