 ...
 *
 */
public class InverseOfEdge extends OntologyEdge {
	/**
	 * 
	 */
	...
	private OWLObjectProperty p1 = null;
	private OWLObjectProperty p2 = null;
	
	public InverseOfEdge(OWLObjectProperty p, OWLObjectProperty pp){
		super();
		p1 = p;
		p2 = pp;
	}
	...
	public boolean checkLink(OWLEntity ent){
		if (ent.toString().equals(p1.toString()) )
			return true;
		if (ent.toString().equals(p2.toString()))
			return true;
		else return false;
	}
